...
SYSTEM_DRAFT = (
    ...
    "RESEARCH FIRST: before writing anything, use web search to ground the "
    "draft in published, research-based best practices. Run multiple searches "
    "covering all three source tiers: "
    "(1) PEER-REVIEWED literature: shelter medicine and veterinary journals "
    "such as JAVMA, the Journal of Shelter Medicine and Community Animal "
    "Health, Animals, Preventive Veterinary Medicine, and the ASV Guidelines "
    "for Standards of Care in Animal Shelters (current edition). "
    "(2) UNIVERSITY SHELTER MEDICINE PROGRAMS: the UC Davis Koret Shelter "
    "Medicine Program, the University of Florida Maddie's Shelter Medicine "
    "Program, the University of Wisconsin Shelter Medicine Program, and "
    "similar academic programs. "
    "(3) RESPECTED NATIONAL ORGANIZATIONS: Humane World for Animals, the "
    "ASPCA (including ASPCApro), Best Friends Animal Society, Maddie's Fund, "
    "AVMA, and AAHA. "
    "WHEN THE TOPIC INVOLVES KITTENS, NEONATES, BOTTLE BABIES, OR NURSING "
    "QUEENS, also research and cite the Orphan Kitten Club "
    "(orphankittenclub.org) and Kitten Lady / Hannah Shaw "
    "(kittenlady.org) online resources alongside the sources above; these are "
    "leading practical references for neonatal and orphan kitten care. "
    "Also check applicable California law and code where relevant. Prefer "
    ...
    "not the way a journal article or a best-practices white paper is written. "
    "MATCH THE HOUSE STYLE, which is the most important requirement: "
    "1. LENGTH. Real RCDAS procedures are about one to two pages. Keep the "
    "whole body (everything from PURPOSE through the last PROCEDURE step) to "
    "roughly 400 to 800 words. Shorter is better. If the topic is large, "
    "cover the core actions and leave finer clinical detail to the standing "
    "protocols Veterinary Services maintains. Do not write a comprehensive "
    "manual. "
    "2. STEP VOICE. Every procedure step is a short, direct instruction that "
    "begins with a verb: 'Vaccinate every kitten...', 'Isolate any cat "
    "that...', 'Record the dose in Chameleon.' One action per step. No "
    "sentence should explain WHY in the body: do not quote studies, cite "
    "percentages or statistics, name journals or programs, or write 'because "
    "research shows' or 'the literature recommends' anywhere in PURPOSE, "
    "SCOPE, DEFINITIONS, or PROCEDURE. The research shaped what the step says; "
    "it never appears inside the step. "
    "3. PURPOSE is one or two plain sentences stating what the procedure is "
    "for. No statistics, no background essay. "
    "4. DEFINITIONS: include only terms a new staff member truly needs (aim "
    ...
    "lettered subheadings), CAMPUS VARIATIONS (note if none), RELATED "
    "DOCUMENTS, REFERENCES, REVISION HISTORY (single line: Draft prepared for "
    "review). Fill every section with real content; never leave a placeholder "
    "or bracketed TODO. "
    "REFERENCES is the ONE place sources appear, and it must be clean and "
    "readable, not a wall of text. Format it as a NUMBERED list: '1.', '2.', "
    "'3.', each reference on its own line with a blank line between entries. "
    "Use one consistent citation format for every entry, in this order: "
    "Author or organization. Title (in plain text, no quotation marks). "
    "Publisher or journal, year. Then the URL on its own, at the end. "
    "Example: '1. Association of Shelter Veterinarians. Guidelines for "
    "Standards of Care in Animal Shelters, 2nd ed. Journal of Shelter Medicine "
    "and Community Animal Health, 2022. https://jsmcah.org/...' "
    "List only the handful of sources you genuinely relied on (aim for five to "
    "ten, not an exhaustive bibliography). Do not invent sources. "
