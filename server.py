...
SYSTEM_DRAFT = (
    ...
    "THEN WRITE a COMPLETE, operational draft, not an outline or skeleton. "
    "Every section must have real content: concrete numbered steps a staff "
    ...
    "requirements. Never leave a section as a placeholder, a bracketed TODO, "
    "or a one-line stub. Use exactly this template structure with these headings: "
    ...
    "REFERENCES, at the bottom, must cite every source you actually consulted "
    "and relied on, one per line, with title, publisher or journal, year, and "
    "URL. Do not invent sources; cite only what your searches returned. "
